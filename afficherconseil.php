        ...
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            <div class="card-body">
              ...
              <h5 class="card-title">blog <span>| Affichage</span></h5>
              <div class="table-responsive">
                <table class="table">
                    ...
                    <?php foreach ($tab as $conseil) { ?>
                        <tr>
                        <td> <?= $conseil['id_con'] ?> </td>
                          
                            <td> <?= $conseil['contenu'] ?> </td>
                            <td> <?= $conseil['date_pub'] ?> </td>
                       
                            
                            <td>
                                    <a href="modifierconseil.php ?id=<?php echo $conseil['id_con']; ?>"><button class="btn btn-outline-success btn-sm">Modifier</button></a>
                              
                                    <a href="supprimerconseil.php?id_con=<?php echo $conseil['id_con']; ?>">
